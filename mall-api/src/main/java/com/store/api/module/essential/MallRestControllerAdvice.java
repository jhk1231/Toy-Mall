package com.store.api.module.essential;

import com.store.api.module.essential.dto.ApiResponseDto;
import com.store.api.module.essential.dto.DefaultErrorResponseDto;
import com.store.api.module.essential.dto.InvalidResponseDto;
import com.store.api.module.essential.error.MallBadRequestException;
import com.store.api.module.essential.error.MallError;
import com.store.api.module.essential.error.MallException;
import com.store.api.module.util.MallErrorLogger;
...
import static com.store.api.module.essential.error.EssentialError.INVALID_REQUEST;
import static com.store.api.module.essential.error.EssentialError.UNKNOWN;
